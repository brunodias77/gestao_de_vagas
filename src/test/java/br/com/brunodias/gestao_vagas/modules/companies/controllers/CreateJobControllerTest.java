...
// @SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT): Esta anotação é
// usada para indicar que o contexto de teste deve ser um aplicativo Spring Boot
// completo.
// webEnvironment = WebEnvironment.RANDOM_PORT: Indica que o servidor web deve
// ser iniciado em uma porta aleatória.
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
// @ActiveProfiles("test"): Esta anotação é usada para especificar o perfil
// ativo durante a execução do teste. Aqui, o perfil "test" é ativado.
@ActiveProfiles("test")
public class CreateJobControllerTest {

        private MockMvc mvc;

        // @Autowired: Esta anotação é usada para realizar a injeção de dependência do
        // Spring. Aqui, o contexto da aplicação web e o repositório de empresas são
        // injetados.
        @Autowired
        ...
        // @Before: Esta anotação é usada para indicar que o método setup() deve ser
        // executado antes de cada método de teste.
        @Before
        public void setup() {
                // MockMvcBuilders.webAppContextSetup(context): Configura o MockMvc com o
                // contexto da aplicação web.
                // apply(SecurityMockMvcConfigurers.springSecurity()): Aplica a configuração de
                // segurança do Spring Security ao MockMvc.
                mvc = MockMvcBuilders.webAppContextSetup(context)
                                .apply(SecurityMockMvcConfigurers.springSecurity())
                                .build();
        }

        // @Test: Esta anotação marca o método como um método de teste que será
        ...
        public void deveria_ser_capaz_de_criar_um_novo_emprego() throws Exception {
                ...
                // Realiza uma requisição POST para criar um novo job e verifica se o status da
                // resposta é 200 (OK).
